...
{
    public static IEnumerable<ProductionStatistic> OrderByOptimizationObjective(this IEnumerable<ProductionStatistic> results,
        OptimizationObjective optimizationObjective)
    {
        switch (optimizationObjective)
        {
            ...
            case OptimizationObjective.MaxAvgProfitOverLastXDaysAndMinLossPercentage:
                return results.OrderBy(p => p.ProfitResultsLastTenDays.LossPercentage).ThenByDescending(p => p.ProfitResultsLastTenDays.AvgProfitPerHour);
                break;
            default:
        ...
        OptimizationObjective optimizationObjective)
    {
        ...
        {
            OptimizationObjective.MaxAvgOverLastXDays => results.MaxBy(p => p.ProfitResultsLastTenDays.AvgProfitPerHour),
